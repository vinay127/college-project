...
public class CollegeProjectRuntimeException extends RuntimeException {

	private ExceptionMessage exceptionMessage;
	private static final long serialVersionUID = -706783001803490307L;

	public CollegeProjectRuntimeException(String message, NotificationInfo notificationinfo, int errorCode) {
		super(message);
